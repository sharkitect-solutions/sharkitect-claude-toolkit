...
## Code example: Checkout Session creation

```js
// Create a Checkout Session for a one-time payment with tax and shipping
...
// For subscriptions, change mode and add trial if needed:
// mode: 'subscription',
